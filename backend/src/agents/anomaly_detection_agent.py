...
if not logger.handlers:
    ...
    log_dir = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../..', 'backend', 'logs'))
...
models_path = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../..', 'backend', 'models'))
...
try:
    requirements_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../..', 'backend', 'requirements.txt')
...
class AnomalyDetectionAgent:
    ...
    def __init__(self, 
        ...
        if data_dir:
            ...
            self.data_dir = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../..', 'backend', 'data'))
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='Example: python anomaly_detection_agent.py --input-file ../../../backend/data/pod_metrics.csv --use-nvidia-llm'
    )
    ...
    parser.add_argument('--data-dir', type=str, default=None,
                        help='Directory for data files (default: backend/data)')
    ...
    try:
        ...
        if args.input_file == 'pod_metrics.csv' and not os.path.exists(args.input_file):
            project_root_file = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../../backend/data/pod_metrics.csv'))
